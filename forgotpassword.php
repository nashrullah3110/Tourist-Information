                     ...
                     if($row=mysqli_fetch_assoc($result))
                         {
                             ...
                             $s_answer=$row['Answer'];
                             if ($question===$s_question AND $answer===$s_answer)
                             {
                             ...
                             {
                                 echo "<script>alert('Incorrect Security question and answer.')</script>";
                             }
                 }
             else
                 {
...
<script src="js/wow.min.js"></script>
 ...
 <div class="flex-container animated zoomIn">
        <div class="column">
        	<h1 class="pet animated slideInLeft">Reset Your Password!</h1><br>
        	...
        	<div class="box">
        		<h2 class="heading animated slideInRight">Log In</h2>
        			<form action="<?php echo ($_SERVER['PHP_SELF']); ?>" id="form" method="post">
        				...
        				</div><select class="inputBox animated slideInRight browser-default custom-select" name="securityquestion">
        				...
        				<input type="submit" name="" value="Submit" class="new animated flipInX">
